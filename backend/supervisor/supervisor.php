    ...
    <main>
        ...
        <form class="form" method="POST">
            ...
            <div class="inputForm">
                ...
                <input type="text" class="input" name="nome_usuario" id="nome_usuario" placeholder="Seu nome de usuário" autocomplete="off" required>
            </div>
            ...
            <div class="inputForm">
                ...
                <input type="password" class="input" name="senha" id="senha" placeholder="Sua senha"  autocomplete="off" required>
            </div>
